...
describe('swaps Controller', () => {
    ...
    describe('create', () => {
        it('should create a new book rating and return a 201 status', async() => {
            const req = {user: 1, body: { collection_id: 7}}
            ...
            expect(Swap.create).toHaveBeenCalledWith({user_requesting:req.user, collection_requested:mockCollection.collection_id, user_offered:mockCollection.user_id})
        ...
        it('should return a 500 status if there is an error creating a swap entry in swaps table', async()=> {
            ...
            expect(Swap.create).toHaveBeenCalledWith({user_requesting: req.user, collection_requested:collection.collection_id, user_offered: collection.user_id })
            expect(Collection.findById).toHaveBeenCalledWith(req.body.collection_id)
    ...
    describe('complete', () => {
        it('should create a new room containg user_offered and user_requesting and return 201 status code.', async() => {
            ...
            expect(Swap.update).toHaveBeenCalledWith(req.params.swap_id, {collection_offered: mockSwap.collection_offered, status:updatedMockSwap.status})
    ...
    describe('destroy', () => {
        it('should create a new room containg user_offered and user_requesting and return 201 status code.', async() => {
            ...
            expect(Swap.findBySwapId).toHaveBeenCalledWith(req.params.swap_id)
            expect(swap.destroy).toBe(undefined)
